...
CLI and TypeScript SDK for managing AWS CloudFormation stacks — create, update, redeploy, and delete — with simple YAML parameter files, real-time event streaming, and color-coded output.
